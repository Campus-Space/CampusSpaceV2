...
We aim to make the life of every SMITian simpler & turn these four years into a smoother ride!</div>
						...
						<div class="footer-contacts"> <i class="icon stroke icon-Phone2"></i> <span class="footer-contacts__inner">Call us +91 9876543210</span> </div>
						<div class="footer-contacts"> <i class="icon stroke icon-Mail"></i> <a class="footer-contacts__inner" href="mailto:abc@xyz.com">mrbeast@vulture.com</a>
					</section>
			  <!-- end footer-section -->
				</div>
			<!-- end col -->
				...
				<div class="col-lg-4 col-sm-4">
					<section class="footer-section" style="padding-top: 18px;">
						...
						<a class="twitter-timeline" data-tweet-limit="3" data-theme="dark" data-link-color="#00BED3" data-chrome="transparent"   href="https://twitter.com/elonmusk">Tweets by Campus Space</a>
					</section>
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="copyright">Copyright © 2016 <a href="https://theuselessweb.com/">Campus Space</a>
				<ul class="social-links list-unstyled">
					<li><a class="icon fa fa-facebook" href="https://longdogechallenge.com/"></a></li>
					<li><a class="icon fa fa-twitter" href="https://cant-not-tweet-this.com/"></a></li>
					<li><a class="icon fa fa-linkedin" href="https://puginarug.com/"></a></li>
				</ul>
			</div>
		  </div>
		</div>
