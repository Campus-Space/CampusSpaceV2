...
<head>
	...
	<?php PrintHeadMetadata( "Campus Space | Contact Us"); ?> </head>
						...
						<div class="col-md-5">
							<section class="section_contacts">
								...
								<ul class="list-social list-inline">
									<!-- add links below -->
									<!-- <li> <a href="https://www.facebook.com/collegespace"><i class="icon fa fa-facebook"></i></a> </li>
									<li> <a href="https://twitter.com/college_space"><i class="icon fa fa-twitter"></i></a> </li>
									<li> <a href="https://plus.google.com/communities/118256355148042817165"><i class="icon fa fa-google-plus"></i></a> </li>
									<li> <a href="https://www.linkedin.com/company/collegespace"><i class="icon fa fa-linkedin"></i></a> </li> -->
								</ul>
								<ul class="list-contacts list-unstyled">
									...
									<li class="list-contacts__item"> <i class="icon stroke icon-House"></i>
										<div class="list-contacts__inner">
											...
											<!-- <div class="list-contacts__info">Azad Hind Fauz Marg, Dwarka Sector-3, New Delhi 110078</div> -->$_GET
