...
<html lang="en">
    <head>
        <?php PrintHeadMetadata( "Campus Space SMIT"); ?>
    ...
    <body>
        <div id="page-preloader">
            <div id="loading-center">
                <h1 id="loading-center" class="preloader_heading animated bounceInDown">Campus Space</h1>
                                        ...
                                        <section class="section-advantages wow">
                                            ...
                                            <ul class="advantages advantages_mod-a list-unstyled">
                                                <li class="advantages__item"> <span class="advantages__icon"><i class="icon stroke icon-Cup"></i></span>
                                                    <div class="advantages__inner">
                                                        ...
                                                        <div class="advantages__info">
                                                            <p>Check out the latest updates from SMIT's admin without any hassle.</p>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="advantages__item"> <span class="advantages__icon"><i class="icon stroke icon-WorldGlobe"></i></span>
                                                    <div class="advantages__inner">
                                                        <h3 class="ui-title-inner decor decor_mod-a">SMITIAN</h3>
                                                            <div class="advantages__info">
                                                                <p>The ultimate destination to explore SMIT! A single platform that presents a humongous pack of movie and food reviews, latest technological releases, thought provoking poetries and the latest trends in the campus.</p>
                                                            </div>
                                                    </div>
                                                </li>
                                                <li class="advantages__item"> <span class="advantages__icon"><i class="icon stroke icon-Users"></i></span>
                                                    <div class="advantages__inner">
                                                        <h3 class="ui-title-inner decor decor_mod-a">Societies And Faculty at SMIT</h3>
                                                        <div class="advantages__info">
                                                            <p>Myriad of societies and our experienced faculty make SMIT what it is. Read on to find out about your honorable professors, society events and much more!</p>
                                                        </div>
                                                    </div>
                                                </li>
                                            </ul>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div style="text-align: center;">
                                        <button class="btn btn-effect btn-info" onclick="window.location='https://ecm.smtech.in/ecm/';">Go to eCM</button>
                                        <iframe src="https://ecm.smtech.in/ecm/" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section class="section-default">
                        <div class="container">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="wrap-title">
                                        <h2 class="ui-title-block" id="pedia">Read on <strong>Sikkim Manipal Institute of Technology</strong></h2>
                                        <div class="ui-subtitle-block ui-subtitle-block_mod-b">Campus Space Blog</div>
                                    </div>
